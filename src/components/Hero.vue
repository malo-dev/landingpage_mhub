    ...
    >
      <div class="text-center space-y-8">
        <Badge variant="outline" class="text-sm py-2">
          ...
          <span>M-STORE — Premier projet M-HUB disponible</span>
        </Badge>
        ...
        >
          <h1>
            <span
              class="text-transparent bg-gradient-to-r from-primary to-[#0099BB] bg-clip-text"
            >M-HUB</span>
            <br />
        ...
        <p class="max-w-screen-sm mx-auto text-xl text-muted-foreground">
          Votre partenaire technologique global — de la RDC au monde entier.
        ...
        <div class="space-y-4 md:space-y-0 md:space-x-4">
          ...
          <Button
            variant="outline"
            class="w-5/6 md:w-1/4 font-bold border-primary text-primary hover:bg-primary hover:text-primary-foreground"
            as-child
          >
